...
OPTION(rgw_gc_processor_max_time, OPT_INT, 15)  // total run time for a single gc processor work
OPTION(rgw_gc_processor_period, OPT_INT, 30)  // gc processor cycle time
